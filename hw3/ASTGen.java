...
// -- Define the grammatical rules of the input language: -----
  ...
  static final public void MasterClass() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 1:
      Class();
      break;
  ...
  static final public void AbstrClass() throws ParseException {
    jj_consume_token(2);
    jj_consume_token(1);
    Id();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public void MasterArg() throws ParseException {
    ParenArg();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 6:
      CurlyArg();
  ...
  static final public void ParenArg() throws ParseException {
    jj_consume_token(3);
    Arg();
    label_2:
    while (true) {
  ...
  static final public void CurlyArg() throws ParseException {
    jj_consume_token(6);
    label_3:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public void ProtectLvl() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 11:
      jj_consume_token(11);
      break;
